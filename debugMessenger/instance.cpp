...
std::vector<const char*> getRequiredExtensions()
{
  ...
  return { glfwExtenstions, glfwExtenstions + glfwExtenstionCount };
}
}
...
Instance::Instance()
{
  ...
  applicationInfo.setApplicationVersion(0);
...
#else
  m_instance = make_instance(true, "Vulkan Engine");
#endif
...
Instance::~Instance()
{
  m_instance.destroy(m_debugUtilsMessenger, nullptr, m_dldi);
  m_instance.destroy();
}
